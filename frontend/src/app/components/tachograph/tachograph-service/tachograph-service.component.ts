...
@Component({
  selector: 'app-tachograph-service',
  templateUrl: './tachograph-service.component.html',
  styleUrls: ['./tachograph-service.component.scss']
})
export class TachographServiceComponent extends RequestBase  implements OnInit {
  requestBody: any = {}
  ...
  async fillFormsFields(request: Request): Promise<void> {
    ...
    this.requestBody.dateOfBirth = !_.isEmpty(this.requestBody.dateOfBirth) ? new Date(this.requestBody.dateOfBirth) : '';
  }
