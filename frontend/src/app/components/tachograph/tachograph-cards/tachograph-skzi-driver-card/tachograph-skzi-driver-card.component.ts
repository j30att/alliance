...
@Component({
  selector: "app-tachograph-skzi-driver-card",
  templateUrl: "./tachograph-skzi-driver-card.component.html",
  styleUrls: ["./tachograph-skzi-driver-card.component.scss"],
})
export class TachographSkziDriverCardComponent
  extends RequestBase
  implements OnInit
{
  uploading = false;
  ...
  async onCreateButton(
    ...
    request.type = RequestType.TYPE_SKZI_DRIVER_CARD;
